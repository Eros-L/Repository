...
主要参考 [Python 基础教程](https://www.runoob.com/python/python-tutorial.html) 与 [Python 3 教程](https://www.runoob.com/python3/python3-tutorial.html)。由于部分特性不常用或者没接触过，我们将不会深入讨论部分章节。相关代码可以在 [Github](https://github.com/Eros-L/Notebook/tree/master/chapter-1) 上下载。
