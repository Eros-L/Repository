...
有关 CFLP 的详细内容可以参考[以下文件](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp/Project.pdf)。
...
实验结果保存在[以下文件夹中](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp/Greedy)。 <br />

简略的结果表保存在[以下文件中](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp/Greedy/result.csv)。 <br />
...
实验结果保存在[以下文件夹中](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp/Tabu)。 <br />

简略的结果表保存在[以下文件中](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp/Tabu/result.csv)。 <br />

#### Comparison

通过比较 Greedy 和 Tabu 的结果，我们能发现 Tabu 在每个实例上都能取得比 Greedy 好的数据，且时间开销平均只为 Greedy 的十倍（每个实例不超过 0.5s）。在某些实例上，Tabu 得到方案的开销仅为 Greedy 的一半左右，则证明使用 Tabu 要远优于使用 Greedy。最后，项目的全部文件保存在[以下文件夹中](https://raw.githubusercontent.com/Eros-L/Eros-L.github.io/master/_posts/cflp)，更详细的结果可在 github 上查看。 <br />
